...
export const TopPage = () => {
    ...
    return (
        <div className={Style.body}>
            ...
            <p className={Style.p}>　【ワシントン＝山内竜介、ロンドン＝池田晋一】米国のバイデン政権は６日、ロシア最大手銀行ズベルバンクの
                ...
                　バイデン大統領は６日の演説で、「戦争犯罪の責任を追及するため、同盟国は団結しなければならない。ロシアの
                経済的な孤立をさらに深める」と訴えた。<br />

                　米国はズベルバンクに対し、既に米金融機関との取引を禁じていたが、米国内の資産を凍結し、米国の企業や個人
                との取引も禁止する。ロシア４位で民間銀行最大手のアルファバンクも制裁対象とし、米国と取引できなくする。<br />

                　ズベルバンクは、世界最大級の国際決済網である国際銀行間通信協会（ＳＷＩＦＴ、本部・ベルギー）からの排除対象
                からは外れていたが、締め付けをより厳しくする。<br />

                　米国からロシアへの新規投資の全面禁止や、米金融機関を通じた債券の償還や利払いの禁止も盛り込んだ。米財務省は
